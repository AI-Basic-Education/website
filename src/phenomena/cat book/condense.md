---
description: 深入介绍深度学习现象，从现象的角度理解深度学习的核心概念和训练过程。
public: true
title: 书籍：《深度学习现象导论》
pubDate: 2025-09-28
# tags:
...
[本仓库(Github)](https://github.com/xuzhiqin1990/understanding_dl) 包含了关于深度学习的讲义和相关资源，从现象出发，帮助深入理解深度学习的核心概念。
...
- [目录](#目录)
  - [第一章 深度学习介绍](#第一章-深度学习介绍)
  - [第二章 数据与神经网络结构](#第二章-数据与神经网络结构)
  - [第三章 维数灾难](#第三章-维数灾难)
  - [第四章 频率原则](#第四章-频率原则)
  - [第五章 基于频率原则设计高效神经网络](#第五章-基于频率原则设计高效神经网络)
  - [第六章 频率原则的机制分析](#第六章-频率原则的机制分析)
  - [第七章 相图分析](#第七章-相图分析)
  - [第八章 凝聚现象](#第八章-凝聚现象)
  - [第九章 损失景观的嵌入原则](#第九章-损失景观的嵌入原则)
  - [第十章 乐观估计](#第十章-乐观估计)
  - [第十一章 解的平坦性](#第十一章-解的平坦性)
  - [第十二章 锚函数：研究语言模型的一类简单函数](#第十二章-锚函数研究语言模型的一类简单函数)
  - [第十三章 复杂度控制对语言模型推理能力的影响](#第十三章-复杂度控制对语言模型推理能力的影响)
  - [第十四章 深度神经网络的更多现象](#第十四章-深度神经网络的更多现象)
  - [第十五章 神经网络求解微分方程](#第十五章-神经网络求解微分方程)
  - [联系方式](#联系方式)
